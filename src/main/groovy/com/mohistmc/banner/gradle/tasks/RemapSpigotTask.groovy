...
class RemapSpigotTask extends DefaultTask {
    ...
    RemapSpigotTask() {
        ...
        includesApi.add("org/bukkit/event/Event/EventException")
        includesApi.add("org/bukkit/event/Event/EventHandler")
        includesApi.add("org/bukkit/event/Event/EventPriority")
